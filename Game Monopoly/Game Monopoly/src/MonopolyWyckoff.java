...
public class MonopolyWyckoff extends JFrame {
    ...
    private GameStyledButton setupBtn(String text, Color bg, String key, int x, int y, int h, boolean isGuest) {
        String iconPath = autoFindImagePath(key);
        if (iconPath != null && iconPath.toLowerCase().contains("_bg")) {
            iconPath = null;
        }
        GameStyledButton btn = new GameStyledButton(text, bg, iconPath);
    ...
    private JPanel createSideMenu() {
        ...
        JButton btnSound = new JButton(isMusicPlaying ? "SOUND: ON" : "SOUND: OFF");
